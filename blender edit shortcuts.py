...
kmi = km.keymap_items.new('blenderedit.set_start_end', 'I', 'PRESS')
kmi_props_setattr(kmi.properties, 'end', False)
kmi = km.keymap_items.new('blenderedit.set_start_end', 'O', 'PRESS')
...
kmi = km.keymap_items.new('blenderedit.cut_all', 'K', 'PRESS', shift=True, alt=True)
kmi_props_setattr(kmi.properties, 'all', True)
kmi_props_setattr(kmi.properties, 'hard', True)
...
kmi = km.keymap_items.new('blenderedit.add_strip_marker', 'M', 'PRESS', alt=True)
kmi = km.keymap_items.new('blenderedit.go_to_markers', 'F5', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'next', False)
kmi = km.keymap_items.new('blenderedit.go_to_markers', 'F6', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'next', True)
kmi = km.keymap_items.new('blenderedit.go_to_markers', 'F5', 'PRESS', alt=True)
kmi = km.keymap_items.new('blenderedit.go_to_markers', 'F6', 'PRESS', alt=True)
